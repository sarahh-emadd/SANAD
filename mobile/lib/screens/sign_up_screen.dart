...
class _SignUpScreenState extends State<SignUpScreen> {
  ...
  Future<void> _handleSignUp() async {
    if (!_agreedToTerms) {
      _showError('Please agree to the Terms of Services and Privacy Policy');
      return;
    }
    ...
    try {
      ...
      if (e.code == 'keychain-error') {
        // Account was created — keychain is a macOS sandbox limitation only
        _navigateToVerification();
      } else {
      ...
      if (_isKeychainError(e)) {
        // Account was created — navigate forward
        _navigateToVerification();
      } else {
            ...
            children: [
              ...
              DropdownButtonFormField<String>(
                ...
                validator: (v) => (v == null || v.isEmpty)
                    ? 'Please select your relation to the elder'
                    : null,
                ...
                hint: Text('Relation to Elder',
                    style: GoogleFonts.inter(
                        fontSize: 14, color: AppTheme.hintGrey)),
