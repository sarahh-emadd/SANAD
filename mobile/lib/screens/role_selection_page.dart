...
class _RoleSelectionPageState extends State<RoleSelectionPage> {
  ...
  /// Persist the chosen role so the smart router in main.dart
  /// can skip directly to the right home screen on subsequent launches.
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  /// 🔹 FILLED BUTTON (Elder)
                  buildFilledButton("I'm an Elder", () async {
                    await _saveRole('elder');
                    if (!mounted) return;
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                  ...
                  buildOutlinedButton("I'm a Caregiver", () async {
                    await _saveRole('caregiver');
                    if (!mounted) return;
                    Navigator.push(
                      context,
                      MaterialPageRoute(
    ...
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(
              color: const Color(0xFF2FA884).withValues(alpha: 0.35),
              blurRadius: 15,
